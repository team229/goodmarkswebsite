            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="font-body-lg text-slate-600 max-w-xl text-lg leading-relaxed">
                  Led by Sunil Gola Sir (DTU), we offer CBSE coaching (Classes 7–12) integrated with IIT JEE & NEET preparation across offline, online, hybrid, and home tutoring formats - all in one place.
                </p>
